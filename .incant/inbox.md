...
- 2026-06-11 Polish problem topo previews on map cards: use an explicit 4:3 frame/viewBox so topo lines do not appear squished, make problem grades more prominent, and move media-card close buttons into high-contrast top-right overlays on photos/topos.
